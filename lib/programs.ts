...
export const PROGRAMS: Programs = {
  ...
  "Захист України": {
    // Розширена програма для військових ліцеїв/закладів з посиленою
    // військово-фізичною підготовкою (7 год/тиждень, 245 год/рік — сума
    // годин по модулях; виправлено невідповідність, що раніше була в описі).
    // Примітка: чинні (2024/2025) методичні рекомендації МОН визначають
    // інваріантну складову профільного рівня як 5 год/тиждень — якщо
    // потрібен варіант, що точно відповідає цьому інваріанту (без
    // додаткових варіативних годин військового ліцею), його ще належить
    // додати окремо. Так само в системі поки немає рівня стандарту
    // (звичайні школи, рекомендовано 2 год/тиждень) — це окрема прогалина.
    "10-11 класи (профільний рівень, військові ліцеї)": { id: "defense-ukraine-10-11-profile", classes: [10,11], description: "7 год/тиждень, 245 год на рік (розширена програма військових ліцеїв)", lessonsPerWeek: 7, hasVariant: false },
  },
